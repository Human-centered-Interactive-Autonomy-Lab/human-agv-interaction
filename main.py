...
from visualization.trust_transition_matrix import plot_trust_transition
from visualization.plot_frechet_heatmap import plot_frechet_heatmap
...
def main():
    ...
    # plot_frechet_heatmap(per_interaction_data, x_col='User_Relative_Speed', color_col = 'Expect', save_path=os.path.join(base_dir, 'images', 'frechet_heatmap.png'))
    ...
    per_interaction_data,
    x_col='Trust',
    y_col='Safe',
    z_col='Expect',
    title= "Expect Surface",
