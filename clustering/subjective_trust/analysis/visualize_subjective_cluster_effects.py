...
def main():
    ...
    # plot_other_gaze_features(behavioral_clustering_data, subjective_clustering_assignments, smoothing='loess', loess_frac=0.1, save_path = os.path.join(save_fig_path, 'other_gaze_features.png')) # save_path = os.path.join(base_dir, 'images', 'other_gaze_features.png')
    ...
    # plot_efficiency_vs_safety(subjective_clustering_data, subjective_clustering_assignments, per_second_data, save_path=os.path.join(save_fig_path, 'subjective_efficiency_vs_safety_by_sc.png'))
    ...
    # plot_cross_first_by_cluster(subjective_clustering_data, subjective_clustering_assignments, save_path=os.path.join(save_fig_path, 'right_of_way_by_sc.png'))
