...
def main():
    ...
    save_df_path = os.path.join(os.path.join(os.path.join(os.getcwd(), "data"), "processed"), "behavioral_clustering_survey_results.csv")
    
    assumption_results = run_pre_post_tests_auto(
    df = subjective_clustering_data,
    cluster_df = behavioral_clustering_assignments,
